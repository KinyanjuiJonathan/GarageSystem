...
const OrderDelivery = () => {
  ...
  const garadgeLocation = {
    latitude: order?.Garadge?.lat,
    longitude: order?.Garadge?.lng,
  };
    ...
    <View style={styles.container}>
      ...
      >
        <MapViewDirections
          ...
          destination={
            order.status === "ACCEPTED" ? garadgeLocation : deliveryLocation
          }
          strokeWidth={10}
          waypoints={
            order.status === "READY_FOR_PICKUP" ? [garadgeLocation] : []
          }
          strokeColor="#3FC060"
        ...
        />
        <CustomMarker data={order.Garadge} type="GARADGE" />
